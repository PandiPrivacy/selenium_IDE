Ниже представлена инструкция созданная мной для работы с selenium ide. Числа (напр. (1.)) обозначают отметки элементов на скриншоте. Скриншоты не удалось восстановить.
